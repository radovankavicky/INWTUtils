...
the package files obtain their own package folder. This also avoids a conflict:
In general, you will have a data folder in an analysis project. Packages also
include a folder named data, so R would try to include your data folder when
